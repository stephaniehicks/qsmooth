...
<<style-knitr, eval=TRUE, echo=FALSE, results=tex>>=
    BiocStyle::latex2()
@
...
<<plot-qsmooth1-weights, fig=TRUE>>=
...
<<plot-qsmooth2-weights, fig=TRUE>>=
